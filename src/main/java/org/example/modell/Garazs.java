...
public class Garazs implements Iterable<Jarmu> {
    ...
    public Garazs() {
        ...
        try {
            jarmuvek.add(new Jarmu("ASD324", 5, 4500000, new UUID(2, 1), "piros", new Tulajdonos("Én")));
            jarmuvek.add(new Jarmu("DNE589", 4, 3900000, new UUID(9,6), "szürke", new Tulajdonos("Te")));
